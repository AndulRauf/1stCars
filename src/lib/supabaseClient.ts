...
*By continuing to use the 1stCars Platform, you acknowledge that you have read, understood, and agreed to these Terms & Conditions.*`,
      ...
      case "faq":
        return [
          ...
          { id: "fq-buy-4", category: "Buying a Car", display_order: 4, question: "Are the kilometers verified?", answer: "We verify the available vehicle information using inspection checks and available service or vehicle-history records. The verification details are provided as part of the vehicle information where available." },
