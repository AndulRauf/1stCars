      ...
      case "pages":
        return [
          ...
          },
          {
            ...
            title: "FAQs",
            slug: "faqs",
content: `# Frequently Asked Questions\n\nEverything you need to know about buying, selling and 1stMark Certified Cars with 1stCars.\n\n## Buying a Car\n\n### 1. What is 1stCars?\n1stCars is a technology-driven pre-owned car marketplace connecting buyers, sellers and verified dealers. We make buying and selling used cars simpler, more transparent and convenient.\n\n### 2. What is a 1stMark Certified Car?\nA 1stMark Certified Car is a vehicle that has undergone our 120-point inspection covering key mechanical, structural and functional areas before being listed as certified.\n\n### 3. Are 1stMark cars single-owner vehicles?\nWhere specified as single-owner, the ownership details are verified against available vehicle and documentation records. Always check the individual vehicle listing for its specific details.\n\n### 4. Are the kilometres verified?\nWe verify the available vehicle information using inspection checks and available service or vehicle-history records. The verification details are provided as part of the vehicle information where available.\n\n### 5. Can I inspect or test drive a car before buying?\nYes, test drives can be arranged for eligible vehicles. Availability depends on the vehicle and location.\n\n## Selling Your Car\n\n### 1. How can I sell my car through 1stCars?\nStart by submitting your car details through our Sell Your Car form. After verification, our team can arrange a free inspection and help you explore the best available selling option.\n\n### 2. Is the car inspection free?\nYes. 1stCars offers a free doorstep inspection for eligible sellers.\n\n### 3. How is my car's price determined?\nWe consider the vehicle's condition, age, kilometres, documentation and current market demand. Depending on the selling route, you may receive an offer from 1stCars or competitive offers through our verified dealer network.\n\n### 4. Do I have to accept the offer?\nNo. You remain in control of the decision. You can review the available offer and decide whether you want to proceed.\n\n## Inspection & Dealer Network\n\n### 1. What does the 120-point inspection cover?\nThe inspection checks key mechanical, electrical, structural, exterior and interior aspects of the vehicle. The purpose is to identify the actual condition of the car before it is certified or offered.\n\n### 2. Who buys cars through 1stCars?\nDepending on the selling route, your car may be purchased by 1stCars, a verified dealer or an eligible buyer connected through the platform.\n\n### 3. What is Dealer Auction?\nDealer Auction allows verified dealers in the 1stCars network to compete for eligible vehicles. This can help sellers discover competitive market offers.\n\n## Payment & Documentation\n\n### 1. When will I receive payment?\nPayment timing depends on the selected selling route and completion of the required documentation. The applicable payment process will be explained before the final handover.\n\n### 2. Does 1stCars help with RC transfer?\nYes. 1stCars provides assistance with the required ownership-transfer documentation and RC transfer process as applicable to the transaction.\n\n### 3. Are there any hidden charges?\nWe aim to keep the transaction transparent. Any applicable charges or deductions will be communicated before you proceed with the transaction.`,
            created_at: new Date().toISOString(),
            is_footer: false
          },
          {
...
*By continuing to use the 1stCars Platform, you acknowledge that you have read, understood, and agreed to these Terms & Conditions.*`,
      ...
      case "faq":
        return [
          // ---- Buying a Car ----
          { id: "fq-buy-1", category: "Buying a Car", display_order: 1, question: "What is 1stCars?", answer: "1stCars is a technology-driven pre-owned car marketplace connecting buyers, sellers and verified dealers. We make buying and selling used cars simpler, more transparent and convenient." },
          { id: "fq-buy-2", category: "Buying a Car", display_order: 2, question: "What is a 1stMark Certified Car?", answer: "A 1stMark Certified Car is a vehicle that has undergone our 120-point inspection covering key mechanical, structural and functional areas before being listed as certified." },
          { id: "fq-buy-3", category: "Buying a Car", display_order: 3, question: "Are 1stMark cars single-owner vehicles?", answer: "Where specified as single-owner, the ownership details are verified against available vehicle and documentation records. Always check the individual vehicle listing for its specific details." },
          { id: "fq-buy-4", category: "Buying a Car", display_order: 4, question: "Are the kilometres verified?", answer: "We verify the available vehicle information using inspection checks and available service or vehicle-history records. The verification details are provided as part of the vehicle information where available." },
          { id: "fq-buy-5", category: "Buying a Car", display_order: 5, question: "Can I inspect or test drive a car before buying?", answer: "Yes, test drives can be arranged for eligible vehicles. Availability depends on the vehicle and location." },
          // ---- Selling Your Car ----
          { id: "fq-sell-1", category: "Selling Your Car", display_order: 1, question: "How can I sell my car through 1stCars?", answer: "Start by submitting your car details through our Sell Your Car form. After verification, our team can arrange a free inspection and help you explore the best available selling option." },
          { id: "fq-sell-2", category: "Selling Your Car", display_order: 2, question: "Is the car inspection free?", answer: "Yes. 1stCars offers a free doorstep inspection for eligible sellers." },
          { id: "fq-sell-3", category: "Selling Your Car", display_order: 3, question: "How is my car's price determined?", answer: "We consider the vehicle's condition, age, kilometres, documentation and current market demand. Depending on the selling route, you may receive an offer from 1stCars or competitive offers through our verified dealer network." },
          { id: "fq-sell-4", category: "Selling Your Car", display_order: 4, question: "Do I have to accept the offer?", answer: "No. You remain in control of the decision. You can review the available offer and decide whether you want to proceed." },
          // ---- Inspection & Dealer Network ----
          { id: "fq-net-1", category: "Inspection & Dealer Network", display_order: 1, question: "What does the 120-point inspection cover?", answer: "The inspection checks key mechanical, electrical, structural, exterior and interior aspects of the vehicle. The purpose is to identify the actual condition of the car before it is certified or offered." },
          { id: "fq-net-2", category: "Inspection & Dealer Network", display_order: 2, question: "Who buys cars through 1stCars?", answer: "Depending on the selling route, your car may be purchased by 1stCars, a verified dealer or an eligible buyer connected through the platform." },
          { id: "fq-net-3", category: "Inspection & Dealer Network", display_order: 3, question: "What is Dealer Auction?", answer: "Dealer Auction allows verified dealers in the 1stCars network to compete for eligible vehicles. This can help sellers discover competitive market offers." },
          // ---- Payment & Documentation ----
          { id: "fq-pay-1", category: "Payment & Documentation", display_order: 1, question: "When will I receive payment?", answer: "Payment timing depends on the selected selling route and completion of the required documentation. The applicable payment process will be explained before the final handover." },
          { id: "fq-pay-2", category: "Payment & Documentation", display_order: 2, question: "Does 1stCars help with RC transfer?", answer: "Yes. 1stCars provides assistance with the required ownership-transfer documentation and RC transfer process as applicable to the transaction." },
          { id: "fq-pay-3", category: "Payment & Documentation", display_order: 3, question: "Are there any hidden charges?", answer: "We aim to keep the transaction transparent. Any applicable charges or deductions will be communicated before you proceed with the transaction." }
        ];
      default:
        return [];
    }
