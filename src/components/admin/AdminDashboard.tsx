...
{ label: "Active Auctions", val: activeAuctionsCount, desc: "Dealer bidding open", color: "bg-indigo-50 border-indigo-200 text-indigo-700", mod: "auctions" as CMSModule, status: "live" },
    ...
    { label: "Cars in Inventory", val: cars.length, desc: pendingCarsCount > 0 ? `${pendingCarsCount} pending approval` : "Published catalog", color: pendingCarsCount > 0 ? "bg-amber-50 border-amber-200 text-amber-700" : "bg-sky-50 border-sky-200 text-sky-700", mod: "cars" as CMSModule, status: "all" },
